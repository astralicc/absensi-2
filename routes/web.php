...
Route::middleware(['auth'])->group(function () {
  ...
  Route::get('/profil/edit', [ProfileController::class, 'showEditProfile'])
    ->name('profile.edit');
  ...
  Route::middleware('role:' . User::ROLE_MURID)->group(function () {
    ...
    Route::get('/lapor-absensi', [AttendanceHistoryController::class, 'report'])
  ...
  Route::middleware(['auth', 'wali-kelas'])->prefix('wali-kelas')->name('wali-kelas.')->group(function () {
  ...
  Route::middleware('role:' . User::ROLE_ADMIN)->group(function () {
    ...
    Route::get('/x-admin/settings', [AdminSettingController::class, 'index'])
      ->name('admin.settings.index');
    Route::post('/x-admin/settings', [AdminSettingController::class, 'update'])
      ->name('admin.settings.update');

    // Admin Wali Kelas Management Routes
    Route::get('/x-admin/wali-kelas', [WaliKelasController::class, 'index'])
      ->name('admin.wali-kelas.index');
    Route::get('/x-admin/wali-kelas/{guru}/edit', [WaliKelasController::class, 'edit'])
      ->name('admin.wali-kelas.edit');
    Route::get('/x-admin/wali-kelas/{guru}/edit', [WaliKelasController::class, 'edit'])
      ->name('admin.wali-kelas.edit');
    Route::put('/x-admin/wali-kelas/{guru}', [WaliKelasController::class, 'update'])
      ->name('admin.wali-kelas.update');
    Route::delete('/x-admin/wali-kelas/{guru}', [WaliKelasController::class, 'destroy'])
      ->name('admin.wali-kelas.destroy');

    // Admin Guru Management Routes  

    Route::get('/x-admin/guru', [AdminGuruController::class, 'index'])
      ->name('admin.guru.index');

    Route::get('/x-admin/guru/create', [AdminGuruController::class, 'create'])
      ->name('admin.guru.create');
    Route::post('/x-admin/guru', [AdminGuruController::class, 'store'])
      ->name('admin.guru.store');
    Route::get('/x-admin/guru/{guru}/edit', [AdminGuruController::class, 'edit'])
      ->name('admin.guru.edit');
    Route::put('/x-admin/guru/{guru}', [AdminGuruController::class, 'update'])
      ->name('admin.guru.update');
    Route::delete('/x-admin/guru/{guru}', [AdminGuruController::class, 'destroy'])
