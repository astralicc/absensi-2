...
<body class="text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-950 min-h-screen">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col md:ml-64 min-w-0">
            @include('admin.layouts.header', ['title' => 'Edit Data Siswa'])
                ...
                <div class="relative overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 mb-6 shadow-sm">
                    ...
                    <div class="relative p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">Edit: {{ $student->name }}</h1>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="class" id="class" required
                                    ...
                                    <option value="X" {{ old('class', $student->getAttribute('class')) == 'X' ? 'selected' : '' }}>X</option>
                                    <option value="XI" {{ old('class', $student->getAttribute('class')) == 'XI' ? 'selected' : '' }}>XI</option>
                                    <option value="XII" {{ old('class', $student->getAttribute('class')) == 'XII' ? 'selected' : '' }}>XII</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="jurusan" id="jurusan" required
                                    ...
                                    <option value="BR" {{ old('jurusan', $student->jurusan) == 'BR' ? 'selected' : '' }}>BR</option>
                                    <option value="AKL" {{ old('jurusan', $student->jurusan) == 'AKL' ? 'selected' : '' }}>AKL</option>
                                    <option value="MP" {{ old('jurusan', $student->jurusan) == 'MP' ? 'selected' : '' }}>MP</option>
                                </select>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="address" id="address" rows="3"
                                    class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition">{{ old('address', $student->address) }}</textarea>
                            </div>
                        </div>
...
<script src="{{ asset('js/min/editSiswa.js') }}"></script>
</html>
