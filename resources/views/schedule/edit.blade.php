...
<head>
    ...
    <title>Edit Jadwal - Absensi SMKN 12 Jakarta</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/dashboard/editJadwal.css') }}">
</head>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out">
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                <a href="{{ route('schedule.manage') }}" class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 bg-purple-50 dark:bg-purple-900/20 rounded-lg border-l-4 border-purple-500">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <!-- Back Button -->
                <div class="mb-6">
                    <a href="{{ route('schedule.manage') }}" class="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition">
                ...
                <!-- Form Card -->
                <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit Jadwal</h2>
                        <p class="text-gray-600 dark:text-gray-400 mt-1">Perbarui informasi jadwal pelajaran</p>
                    </div>
                    
                    <form action="{{ route('schedule.update', $schedule->id) }}" method="POST" class="p-6 space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="class" name="class" value="{{ old('class', $schedule->class) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="subject" name="subject" value="{{ old('subject', $schedule->subject) }}" required
                        ...
                        <!-- Teacher -->
                        <div>
                            <label for="teacher" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Guru Pengajar <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="teacher" name="teacher" value="{{ old('teacher', $schedule->teacher) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="room" name="room" value="{{ old('room', $schedule->room) }}" required
...
<script src="{{ asset('js/schedule/editJadwal.js') }}"></script>
</html>
