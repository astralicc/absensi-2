 // Dark mode toggle with smooth animation
        function toggleDark() {
            ...
            darkBtn.classList.add('ring-2', 'ring-blue-400', 'ring-offset-2', 'dark:ring-offset-gray-900');
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    darkBtn.classList.remove('ring-2', 'ring-blue-400', 'ring-offset-2', 'dark:ring-offset-gray-900');
                }, 250);
            }, 200);
        }
